...
const historical_angular_js_1 = require("./historical.angular.js");
/**
...
let HistoricalService = class HistoricalService {
    constructor() {
         ...
         */
        this.historicalInstances = new Map();
    }
    /**
    ...
    getHistorical(key, defaultValue, options) {
        if (!this.historicalInstances.has(key)) {
            this.historicalInstances.set(key, new historical_angular_js_1.Historical(defaultValue, options));
        }
